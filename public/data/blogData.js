export const blogData = {
    ...
    cards: [
        {
            id: "1",
            imgUrl: "/blog/Ukraine_Child_Toys.jpeg",
            alt: "Child Toys",
            date: "8/16/23",
        ...
        {
            id: "2",
            imgUrl: "/blog/Elizabeth-Ames.jpeg",
            alt: "Elizabeth Stechu",
            date: "6/28/23",
            title: "Elizabeth’s Letter From Kyiv",
            description: "A letter from our CEO, Elizabeth Ames, on her most recent trip to Kyiv…",
            btn: "Read More",
            btnUrl: "/blog/",
            date: 'Aug 16',
            blogDetail: [
                {
                    detail: "A letter from our CEO, Elizabeth Ames, on her most recent trip to Kyiv: "
                },
                {
                    detail: "Dear Friends,"
                },
                ...
                },
                {
                    ...
                    alt: "UPRA_Conference",
                    detail: "I saw compelling success from HUT’s initiatives.  The UPRA conference, sponsored by HUT, was a groundbreaking medical conference supported by the Ukrainian Ministry of Health and held at a leading military rehabilitation hospital."
                },
                {
                    imgUrl: "",
                    alt: "",
                ...
                {
                    detail: "Here are a few more stories and images from my trip to give you a flavor for Kyiv today:"
                },
                {
                    imgUrl: "/blog/Russian_Vehicle.jpeg",
                    alt: "Russian_vehicle",
                    detail: "There’s an exhibit on St. Michael’s Golden-Domed Monastery Plaza of bombed out Russian tanks, rockets, and vehicles.  Kids played on them, and teens climbed all over the tanks. </br> </br> Patriotism is a completely reflexive and natural part of life in Ukraine these days. </br> </br> One night, a Kinzhal hypersonic missile was shot down not far from where I was staying.  I leaned out the window to see crowds looking to the sky, clustered around the metro entrance."
                },
                {
                    detail: "As the gunfire began and I put on my shoes, the most beautiful baritone voice rose from the crowd across the street as a man began to sing the national anthem acapella."
                },
                {
                    detail: "In that moment, I was not afraid.  Experiencing Kyiv without a filter of hypervigilance was amazingly beautiful.  As someone who was so profoundly affected living through 25 years of PTSD, it was a very, very special thing: I was able to embrace the beauty and learning of the moment rather than feeling fear."
                },
                {
                    detail: "May we all feel life’s beauty around us.  May we all live without fear."
                },
                {
                ...
                {
                    detail: "In 1992 I saw examples of mental health conditions that went back to WW2 and before.  My <q>'a-ha'</q> moment was without treatment and a different approach, the Ukrainian population would be suffering in similar number in 50 years, no matter the outcome of the war itself.  I don't think you do a startup based only on metrics. "
                },
                {
                    detail: "I am so proud of and truly honored to be part of HUT’s amazing team, working with our Ukrainian partners and colleagues to help rewrite Ukraine's history of post-conflict mental health outcomes."
                },
                {
                    detail: "Ukraine is a country of brilliant, sophisticated, imaginative and above all, patriotic individuals who never asked for the death and destruction Russia continues to rain down:"
                },
                {
                    detail: "Thank you for not forgetting us."
                },
                {
                    detail: "So gratefully,"
                },
                {
                    detail: "Liz xx"
                },
                {
                    detail: "(Elizabeth Ames, CEO and Co-founder)"
                },
            ],
            filterList: [
                {
        ...
        {
            id: "3",
            imgUrl: "/blog/flag.jpeg",
            alt: "Flag",
            date: "6/14/23",
            title: "Our Founding Story",
            description: "Over a year on from Russia’s invasion of Ukraine, the Ministry of Health predicts that around 11 million people will suffer from common mental health disorders…",
            btn: "Read More",
            btnUrl: "/blog/",
            date: 'Jun 14',
            blogDetail: [
                {
                    detail: "Over a year on from Russia’s invasion of Ukraine, the Ministry of Health predicts that around 11 million people will suffer from common mental health disorders, and around 2 million will suffer from severe mental health disorders. However, only 2.5% of Ukraine’s health care budget goes towards mental health, the equivalent of each citizen receiving just $5 for support each year. It’s not just about the numbers – people need evidence-based and practical healthcare approaches to begin to heal. With this goal in mind, our team founded Heal Ukraine Trauma to provide <b>better solutions for mental health</b> based on our expertise in healthcare, nonprofits, business, and government, as well as on-the-ground experience in Ukraine."
                },
                {
            ...
            heading: "Help us support Ukraine by <a href='/donate'>donating today</a>",
            filterList: [
                {
                    list: "trauma",
                },
