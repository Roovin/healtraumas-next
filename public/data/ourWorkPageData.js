const intro = {
  ...
  paragraph2: "Our goal is to help Ukrainian adults and children heal from conflict-related trauma so that they can live fulfilling, productive lives. We work with international trauma experts and Ukrainian partners to scale existing evidence-based programs and pilot innovative solutions for:",
  points: [
    {
      id: 1,
      listTitle: "Veterans",
...
const colTwoContentData = [
  ...
  },
  {
    ...
    btn: { text: "Get Involved", btnUrl: "/contact-us", btnClass: "default" },
  }
]

const parallaxBlade = {
  title: "Veterans Programs",
  imgUrl: "/parallaxImg/parallaxImg_1.jpeg",
  parallax: "parllaxOne"
};
...
const intro2 = {
  bgskyblue: "bg-white",
  bgImage: "",
  paragraph: "There are currently over 500,000 people in the Ukrainian military. Data in Ukraine from 2012-2021 shows that military hospital admissions for mental health increased 6.97 times during periods of active hostility. Another study found that 57% of Ukrainian veterans needed psychological support. The end of the war could lead to a wave of severe mental health disorders among veterans and first responders.",

};

const contentwithVideo = {
  title: "Conference on PTSD Therapies",
  paragraph: "In 2023, Heal Ukraine Trauma sponsored the first medical conference on psychedelic-assisted therapy (PAT) in Ukraine for the treatment of PTSD. This event was organized by the Ukraine Psychedelics Research Association (UPRA) and hosted by the Forest Glade military rehabilitation hospital. International experts presented scientific and clinical data on the use of PAT, and veterans shared their personal experiences and insights. The conference was <span>viewed online by over 12,000 people.<span/>",
...
const contentwithVideo2 = {
  ...
  paragraph: "HUT has partnered with Fluence, a leader in psychedelic therapy training, and the Ukrainian Psychedlic Research Association to make Fluence’s introductory course on psychedelic-assisted therapy available for free in Ukrainian language for psychologists and medical doctors addressing war-related trauma. .",
  paragraph2: "",
  imgurl: "/contentWithVideo/colTwo_img5.jpg",
...
const contentwithVideo3 = {
  title: "KAP Training",
  paragraph: "<i>Program under development</i>",
  ...
  imgurl: "/contentWithVideo/colTwo_img4.jpeg",
}
...
const contentwithVideo4 = {
  title: "Teaching Recovery Techniques (TRT)",
