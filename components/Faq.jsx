          ...
          return (
            <div key={i} className="item mb-[40px]">
              <div className="titleWrap">
                <h6 className="text-blue mb-5 flex md:mb-4  ">
                  <span className="inline-block pr-[10px] relative">
                    {i + 1}.
                  </span>
                  {item?.title}
                </h6>
            ...
            {data?.links?.map((item, i) => {
              return (
                <li key={i} className="mb-[29px]">
                  <Link href={item?.url} className="underline break-all flex ">
                    <span className="inline-block pr-[10px]">{i + 1}</span>
                    {item?.url}
                  </Link>
                </li>
              );
